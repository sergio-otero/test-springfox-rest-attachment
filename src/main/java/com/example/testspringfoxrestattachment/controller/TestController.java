package com.example.testspringfoxrestattachment.controller;
...
public class TestController {
	...
	// It works by url, not in swagger-ui. The downloaded file is corrupted. See testDownloaded.zip vs test.zip
